...
@NgModule({
  ...
  declarations: [MainComponent, ResumenClinicoComponent, HeaderComponent, FooterComponent, SidebarComponent, MotivoConsultaComponent, ProfesionalesComponent, ResultadosEstudiosComponent, MedicamentosComponent, InternacionesComponent]
})
